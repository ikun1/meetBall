...
public class CustomTitleBar extends RelativeLayout {
    ...
    public void init(Context context, AttributeSet attributeSet){
        ...
        int leftIcon = typedArray.getResourceId(R.styleable.CustomTitleBar_left_icon, R.drawable.ic_ball);//左边图片
        int rightIcon = typedArray.getResourceId(R.styleable.CustomTitleBar_right_icon, R.drawable.football);//右边图片
